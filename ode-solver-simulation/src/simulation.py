import numpy as np
import pandas as pd
from utils import sweep_parameters, runs, params
...
exponents = np.arange(5, 7, 0.25)
alpha_values = 7 * 10**(-exponents)
s3= sweep_parameters(p,'a',alpha_values)


#Fourth simulation: alpha is randomly picked value from a uniform distribution for each n_strain
